...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText( this, "Inernet connection required for this app...", Toast.LENGTH_SHORT ).show();
    ...
    public void onClick(View v)
    {
      /*  if(CheckGooglePlayServices())
        {
            Toast.makeText(this, "LOcation play services", Toast.LENGTH_SHORT).show();
        }
        else
        {
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyBBKkYVSNvdLEgTCTZBfl7zjNqcGuJ2XDo");
